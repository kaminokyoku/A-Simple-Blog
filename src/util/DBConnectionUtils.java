...
public class DBConnectionUtils {
     ...
     * src folder. Note the difference in how you access files stored here, compared with the
     ...
     */
    public static Connection getConnectionFromSrcFolder(String propsName) throws IOException, SQLException {

        // The getResourceAsStream method can be used to load any files on a program's classpath.
        // Any files you put into the src folder will end up on the classpath at runtime.
     ...
     * {@link #getConnectionFromSrcFolder(String)} method above.
     *
